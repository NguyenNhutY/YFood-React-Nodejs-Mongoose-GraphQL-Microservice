...
import cartSchema from './cart.schema.js';  // Import material schema
import cartResolver from "./cart.resolver.js"; // Material batch resolvers
...
const schema = buildSubgraphSchema({
  typeDefs: [cartSchema], // Merge your typeDefs here
  resolvers: {
    ...cartResolver,  // Your resolvers
  },
});
