...
import userSchema from './user.schema.js';  // Import material schema
import userResolver from "./user.resolver.js"; // Material batch resolvers
...
const schema = buildSubgraphSchema({
  typeDefs: [userSchema], // Merge your typeDefs here
  resolvers: {
    ...userResolver,  // Your resolvers
  },
});
...
app.listen(PORT, () => {
  console.log(`Cart service is running on http://localhost:${PORT}/graphql`);
});
