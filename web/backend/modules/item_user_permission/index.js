...
import itemUserPermissionSchema from './item_user_permission.schema.js';  // Import material schema
import itemUserPermissionResolver from "./item_user_permission.resolver.js"; // Material batch resolvers
...
const schema = buildSubgraphSchema({
  typeDefs: [itemUserPermissionSchema], // Merge your typeDefs here
  resolvers: {
    ...itemUserPermissionResolver,  // Your resolvers
  },
});
